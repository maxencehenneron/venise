...
func (dec *Pbf) readFileBlock() (*OSMPBF.BlobHeader, *OSMPBF.Blob, error) {
...
func (dec *Pbf) readBlobHeaderSize() (uint32, error) {
	dec.buf.Reset()
...
func (dec *Pbf) readBlobHeader(size uint32) (*OSMPBF.BlobHeader, error) {
	dec.buf.Reset()
...
func (dec *Pbf) readBlob(blobHeader *OSMPBF.BlobHeader) (*OSMPBF.Blob, error) {
	dec.buf.Reset()
...
func (dec *Pbf) readOSMHeader() error {
	var err error
...
func (dec *Pbf) decodeOSMHeader(blob *OSMPBF.Blob) error {
